...
function getDocumentHtml(data: NpaData): string {
    ...
    return `
                            ...
                            <div style="margin-bottom: 1cm; page-break-inside: avoid;">
                                ...
                                : 
                                    `<div class="rich-content">
                                        ${!hasTitle ? `<p><strong>${subsection.numero}</strong>&nbsp;` : ''}
                                        ${subsection.conteudo}
                                        ${!hasTitle ? `</p>` : ''}
                                            ...
                                            `<div style="margin-top: 0.5cm;">
                                                ${subsection.subSubsections.map(sss => `
                                                    <div style="margin-bottom: 0.5cm;">
                                                        ${sss.titulo ? `<p style="margin: 0; font-weight: bold;">${sss.numero} ${sss.titulo}</p>` : `<p><strong>${sss.numero}</strong>&nbsp;`}
                                                        <div class="rich-content">${sss.conteudo}</div>
                                                        ${!sss.titulo ? `</p>` : ''}
                                                    </div>
                                                `).join('')}
                                            </div>` 
        ...
        <!-- ANEXO A -->
        <div class="page-container">
            <h2 style="text-align: center; font-size: 14pt; text-transform: uppercase; font-weight: bold; margin-bottom: 1cm;">Anexo A - Tabela de Efetivo Proposto</h2>
            <p>&nbsp;</p>
