    ...
    printWindow.document.write(`
        ...
        <head>
            ...
            <style>
                ...
                body { margin: 0; padding: 0; background-color: white; font-family: "Times New Roman", Times, serif; color: black; }
                .page-container {
                    width: 210mm; min-height: 297mm;
                    padding: 30mm 20mm 20mm 30mm; /* S: 3cm, D: 2cm, I: 2cm, E: 3cm */
                    box-sizing: border-box; margin: 0 auto;
                    line-height: 1.5; text-align: justify; position: relative;
                    page-break-after: always; font-size: 12pt;
                }
                .page-break { page-break-after: always; }
                p { margin: 0; }
                table { width: 100%; border-collapse: collapse; }
                .rich-content p { text-indent: 2.5cm; text-align: justify; margin: 0; }
                .mirror-header {
                    position: absolute; top: 15mm; left: 30mm; right: 20mm;
                    display: flex; justify-content: space-between;
                    font-size: 11pt; font-weight: bold; pointer-events: none;
                }
                @media print { .page-container { margin: 0; width: 100%; } }
            </style>
        </head>
        <body>
            <div id="print-root">${getDocumentHtml(data)}</div>
            <script>
                window.onload = () => {
                    ...
                    pages.forEach((page, index) => {
                        ...
                        if (pageNum > 1) { 
                            ...
                            if (pageNum % 2 === 0) {
                                left.innerText = docNum; right.innerText = pageNum + " / " + totalPages;
                            } else {
                                left.innerText = pageNum + " / " + totalPages; right.innerText = docNum;
                            }
                            headerDiv.appendChild(left); headerDiv.appendChild(right);
